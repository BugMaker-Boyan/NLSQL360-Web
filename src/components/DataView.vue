...
onMounted(() => {
    const container = document.getElementById('dataview-container');
    while (container.firstChild) {
        container.removeChild(container.firstChild);
    }
    const svg = initSankeyChart({
        links: energy
    }, {
...
<template>
    <div class="frameworkTitle" style="padding-right: 10px;">
        ...
        <div style="float: right; margin-top: 3px">
            <span>Select Dataset Attributes: </span>
            <el-select placeholder="Select" style="width: 100px">
            </el-select>
        </div>
    </div>

    <div class="frameworkBody" style="padding: 10px;">
        <div id="dataview-container"></div>
    </div>
</template>
